    ...
    if (this.state.consentComplete === 0) {
      return (
        <div className="placeMiddle">
          ...
          Wenn Sie mit damit einverstanden sind, kreuzen Sie bitte die Kästchen 
          auf der zweiten Seite dieses Formulars an, 
          um Ihre Zustimmung zu dieser Studie zu geben. 
          Bitte beachten Sie, dass Sie nicht an der Studie teilnehmen können, 
          sofern Sie Ihre vollständige Zustimmung nicht geben.
          <br />
          <br />
          <Consent.Survey
